...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle"></i> <?php echo $lang['title'] ?>
            ...
            <div class="col-md-5">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="<?= ($active == "details")? "active" : "" ?>"><a href="#details" data-toggle="tab"><?php echo $lang['tab_details'] ?></a></li>
                        <li class="<?= ($active == "changepass")? "active" : "" ?>"><a href="#changepass" data-toggle="tab"><?php echo $lang['tab_chpass'] ?></a></li>                        
                    </ul>
                    <div class="tab-content">
                        <div class="<?= ($active == "details")? "active" : "" ?> tab-pane" id="details">
                            <form action="<?php echo base_url() ?>profileUpdate" method="post" id="editProfile"  enctype="multipart/form-data" role="form">
                                <?php $this->load->helper('form'); ?>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">                                
                                            <div class="form-group">
                                                <label for="image"><?php echo $lang['lbl_image'] ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">                                
                                            <div class="form-group">
                                                <label for="fname"><?php echo $lang['lbl_fullname'] ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="mobile"><?php echo $lang['lbl_phone'] ?></label>
                            ...
                            <form role="form" action="<?php echo base_url() ?>changePassword" method="post">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="inputPassword1"><?php echo $lang['lbl_oldpass'] ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="inputPassword1"><?php echo $lang['lbl_newpass'] ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="inputPassword2"><?php echo $lang['lbl_cnewpass'] ?></label>
                                ...
                                <div class="box-footer">
                                    <input type="submit" class="btn btn-primary" value="<?php echo $lang['btn_submit'] ?>" />
                                    <input type="reset" class="btn btn-default" value="btn_reset" />
                                </div>
                            </form>
                        </div>                        
                    </div>

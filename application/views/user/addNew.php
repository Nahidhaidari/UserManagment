            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" accept-charset="UTF-8" action="<?php echo base_url() ?>addNewUser" method="post" role="form"  enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="password"><?php echo $lang['lbl_password'] ?></label>
                                        <input type="password" class="form-control required" id="password" name="password" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cpassword"><?php echo $lang['lbl_cpassword'] ?></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="mobile"><?php echo $lang['lbl_mobile'] ?></label>
                                        <input type="text" class="form-control required digits" id="mobile" value="" name="mobile" maxlength="10">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="role"><?php echo $lang['lbl_role'] ?></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="fname"><?php echo $lang['lbl_image'] ?></label>
                                        <input type="file" class="form-control required" value="<?php echo set_value('image'); ?>" id="image" name="image" maxlength="128">
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
